...
## OTHER PUBLICATIONS
- Özcan, Emrah. (2020). Sözcük Tanımlamada Anlık Oluşum (Version 1). In DİLBİLİMDE GÜNCEL TARTIŞMALAR (pp. 141–150). Ankara, Turkey: Dilbilim Derneği Yayınları. [(Download)](http://doi.org/10.5281/zenodo.4531651){: target="_blank"}
